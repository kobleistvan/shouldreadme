use utf8;
package Model::Schema::Result::FaqQuestion;
...
=head1 TABLE: C<FAQ_question>

=cut

__PACKAGE__->table("FAQ_question");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8e2THF64PEhA5C1EiyDL7A
